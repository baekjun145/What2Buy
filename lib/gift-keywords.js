...
const INTEREST_KEYWORDS = {
  ...
  "뷰티·패션": ["향수", "립스틱", "맥립스틱", "샤넬립스틱", "디올립스틱", "입생로랑립스틱", "톰포드립스틱", "이솝핸드크림", "논픽션핸드크림", "록시땅핸드크림", "고급핸드크림", "스킨케어세트", "바디로션", "바디미스트", "수분크림", "헤어에센스", "마스크팩", "선크림", "니트", "코트", "카디건", "가방", "지갑", "카드지갑", "목걸이", "귀걸이", "반지", "시계", "선글라스", "머플러", "벨트", "모자"],
...
const KEYWORDS = [
  ...
  { keyword: "모니터", category: "50000003", audience: "adult", budgets: ["10만원 이상"], situations: ["승진·이직", "졸업·입학"] },
  ...
  { keyword: "만년필", category: "50000008", audience: "adult", budgets: ["3~5만원대", "5~10만원대", "10만원 이상"], situations: ["승진·이직", "졸업·입학", "감사 인사"] },
  { keyword: "다이어리", category: "50000008", audience: "adult", budgets: ["3만원 미만", "3~5만원대"], situations: ["졸업·입학", "승진·이직", "감사 인사"] },
